...
do
    ...
    do
        ...
        # Ploting  the data
        python3 ../plot.py --suffix full --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "Mean number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/*.dat
        python3 ../plot.py --suffix 324-972 --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "Mean number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/{324,648,972}.dat
        python3 ../plot.py --suffix 1944-10100 --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "Mean number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/{1944,3888,7776,10110}.dat
...
do
    ...
    do
        ...
        # Ploting  the data
        python3 ../plot.py --suffix full --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "std in number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/*.dat
        python3 ../plot.py --suffix 324-972 --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "std in number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/{324,648,972}.dat
        python3 ../plot.py --suffix 1944-10100 --yRange "(0,0.5)" --xRange "(0,250)" --xLabel "std in number of ${lipid} in ${lipid} clusters" --dat_files freeEnergyLandscapes/{1944,3888,7776,10110}.dat
