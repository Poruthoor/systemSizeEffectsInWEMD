...
colorDict = {"324":"blue", "648":"brown", "972":"green", "1944":"red",
             "3888":"purple", "7776":"olive", "10110":"white"}
...
for l in legendRange:
    ...
    for j in range(len(args.dat_files)):
        ...
        if FileName in args.dat_files[j]:
            ...
            axs.plot(nice_x,nice_y,label=str(legend[l]) + " lipids", alpha=0.9,
                     linewidth=5, c=color)
            axs.set_xlim(tupX)
            axs.set_ylim(tupY)
...
axs.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4,
           frameon=False)
