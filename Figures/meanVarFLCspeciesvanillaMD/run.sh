...
do
    ...
    do
        ...
        do
            ...
            do
                mkdir -p ${lipid}/${size}/
                python3 ../src/avgVar_stdMD.py --replicaNum ${replica} --dat_file ../data/vanillaMD/clusby_${lipid}/${size}/${temp}/${replica}.dat >> ${lipid}/${size}/${temp}.dat
            done
...
# Ploting the data
python3 plot2.py --suffix "lipid_FLC"  --dat_file *.dat
